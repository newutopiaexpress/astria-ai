  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        google:"outline outline-4 border border-stone-300 outline-offset-2 outline-stone-300/50 shadow-sm transition-all duration-100 text-sm bg-stone-200 rounded-3xl text-stone-800 hover:outline hover:outline-offset-1 hover:outline-green-400 hover:outline-1 hover:shadow-md",
