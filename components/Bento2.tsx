        ...
        <div className="text-left md:text-center md:pt-0 mb-12 md:mb-0">
          ...
          */} 
            ...
            <div className="mx-auto text-center bg-stone-800/0 py-12 w-full flex justify-center items-center">
                ...
                <span className="font-normal text-5xl mr-4 pr-9 border-r border-stone-100/20">
                    9<span className="text-xl align-top border-b border-stone-100">99</span><span className="font-normal text-[16px] -ml-6 opacity-50">€</span>
                </span>   
...
export function SparkleIcon() {
    return (
  <svg className="animate-pulse w-5 h-5 ml-2 fill-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
