    ...
    const body = {
      tune: {
        ...
        prompts_attributes: [
          ...
          {
            text: `editorial portrait of ohwx ${type}, detailed face, dark background, dramatic lighting, friendly look, dark, warm, cozy athmosphere, professional, picturesque, masterpiece photography`,
            negative_prompt:`bad anatomy, red eyes, ugly, old, sad`,
            callback: promptWebhookWithParams,
            num_images: 1,
          },
